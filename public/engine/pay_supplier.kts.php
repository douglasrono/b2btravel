...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        $sql1 = "INSERT INTO supplier_transactions (supplier_id, amount, type, date, method) 
        ...
        $sql2 = "UPDATE supplier_accounts SET amount_owed = amount_owed - $amount WHERE supplier_id = $sid";
